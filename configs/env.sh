...
SYS_VERSION='0.0.1'                             # System version
...
ACCESS_TOKEN_EXPIRE='120'                       # [MINUTES] Access token expiration time
...
RFRESH_TOKEN_EXPIRE='360'                       # [MINUTES] Refresh token expiration time
...
POSTGRES_BASE='gopassdb'                        # Postgres BASE
